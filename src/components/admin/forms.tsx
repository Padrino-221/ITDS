import type { NewsPost, Project, Lecturer, ResearchArea, Program } from "@prisma/client";
import {
  createNews,
  createProject,
  createLecturer,
      ...
      <AdminCard>
        <div className="grid gap-5">
          ...
          <Field label="Content" required hint="Separate paragraphs with a blank line.">
            <TextArea name="content" rows={10} required minLength={10} defaultValue={post?.content ?? ""} />
          </Field>
